...
# Construct the path to the lyrics
lyrics = os.path.join(dirname, u'lyrics.txt')
# Make your bot read the book!
tweetbot.read(lyrics)
...
cons_key = 'tvhrprOnoc15QIsUJQOx80MtQ'
# Consumer Secret (API Secret)
cons_secret = 'QezDqVGOtrJ7wtZVD9TObtwyiE0S9ANKcpwasoqZ640m355HuM'
# Access Token
